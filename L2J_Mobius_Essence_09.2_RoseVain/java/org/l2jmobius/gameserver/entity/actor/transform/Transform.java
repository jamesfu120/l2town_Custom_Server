 ...
 */
package org.l2jmobius.gameserver.entity.actor.transform;
...
public class Transform
{
	...
	public void onTransform(Creature creature, boolean addSkills)
	{
		...
		if (_type != TransformType.MODE_CHANGE) // Wargs should continue attack when transformed.
		{
		...
		if (template != null)
		{
			...
			if (creature.isPlayer())
			{
				...
				if (_type != TransformType.MODE_CHANGE)
				{
