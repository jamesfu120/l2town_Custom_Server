...
public class ChatGeneral implements IChatHandler
{
	...
	public void onChat(ChatType type, Player activeChar, String paramsValue, String text)
	{
		...
		if (!vcdUsed)
		{
			...
			{
				activeChar.sendPacket(new SystemMessage(SystemMessageId.GENERAL_CHAT_CANNOT_BE_USED_BY_CHARACTERS_OF_LV_S1_OR_LOWER).addInt(GeneralConfig.MINIMUM_CHAT_LEVEL));
				return;
			}
