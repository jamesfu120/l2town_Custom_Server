 ...
 */
package org.l2jmobius.gameserver.entity.actor.tasks.player;
	...
	public void run()
	{
		if (_player != null)
		{
			if (_player.isOnline())
			{
				...
				_player.sendPacket(new SystemMessage(SystemMessageId.YOU_HAVE_BEEN_PLAYING_FOR_S1_HOUR_S_HOW_ABOUT_TAKING_A_BREAK).addLong(hours));
			}
			else
			{
