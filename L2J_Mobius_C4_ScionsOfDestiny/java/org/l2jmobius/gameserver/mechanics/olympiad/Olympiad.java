...
public class Olympiad extends ListenersContainer
{
	...
	private void updateCompStatus()
	{
		...
		_scheduledCompStart = ThreadPool.schedule(() ->
		{
			...
			World.broadcastToAllOnlinePlayers(new SystemMessage(SystemMessageId.THE_OLYMPIAD_GAME_HAS_STARTED));
			...
			if (regEnd > 0)
			{
				ThreadPool.schedule(() -> World.broadcastToAllOnlinePlayers("The Grand Olympiad registration period has ended."), regEnd);
			}
			...
			_scheduledCompEnd = ThreadPool.schedule(() ->
			{
				...
				_inCompPeriod = false;
				World.broadcastToAllOnlinePlayers(new SystemMessage(SystemMessageId.THE_OLYMPIAD_GAME_HAS_ENDED));
