...
public class ChatWhisper implements IChatHandler
{
	...
	public void onChat(ChatType type, Player activeChar, String target, String text)
	{
		...
		if ((receiver != null) && !receiver.isSilenceMode(activeChar.getObjectId()))
		{
			...
			{
				activeChar.sendPacket(new SystemMessage(SystemMessageId.PLAYERS_CAN_RESPOND_TO_A_WHISPER_BUT_CANNOT_INITIATE_A_WHISPER_UNTIL_LV_S1).addInt(GeneralConfig.MINIMUM_CHAT_LEVEL));
				return;
			}
