...
public class SellBuffsManager implements IXmlReader
{
	...
	private String buildBuffMenu(Player seller, int index)
	{
		...
		for (SellBuffHolder holder : sellList)
		{
			...
			sb.append("<td align=right fixwidth=\"40\"><button value=\"Buy Buff\" action=\"bypass sellbuffbuyskill " + seller.getObjectId() + " " + skill.getId() + " " + index + "\" width=\"75\" height=\"21\" back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
			sb.append("<td align=right fixwidth=\"40\"><button value=\"Buy Buff\" action=\"bypass sellbuffbuyskillPet " + seller.getObjectId() + " " + skill.getId() + " " + index + "\" width=\"75\" height=\"21\" back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
			sb.append("</tr>");
			sb.append("<tr><td><br></td></tr>");
		}
		...
		if (previousIndex > -1)
		{
			sb.append("<td align=left><button value=\"Previous Page\" action=\"bypass sellbuffbuymenu " + seller.getObjectId() + " " + previousIndex + "\" width=\"95\" height=\"21\" back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
		}
		
		if (nextIndex > -1)
		{
			sb.append("<td align=right><button value=\"Next Page\" action=\"bypass sellbuffbuymenu " + seller.getObjectId() + " " + nextIndex + "\" width=\"95\" height=\"21\" back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
		}
		sb.append("</tr>");
		sb.append("</table>");
		return sb.toString();
	...
	private String buildSkillMenu(Player player, int index)
	{
		...
		if (previousIndex > -1)
		{
			sb.append("<td align=left><button value=\"Previous Page\" action=\"bypass sellbuffadd " + previousIndex + "\"  width=\"95\" height=\"21\" back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
		}
		
		if (nextIndex > -1)
		{
			sb.append("<td align=right><button value=\"Next Page\" action=\"bypass sellbuffadd " + nextIndex + "\" width=\"95\" height=\"21\" back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
		}
		sb.append("</tr>");
		sb.append("</table>");
		return sb.toString();
