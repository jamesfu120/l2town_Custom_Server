...
public class CommandChannel extends AbstractPlayerGroup
{
	...
	public CommandChannel(Player leader)
	{
		...
		party.broadcastString("A command channel has been closed.");
	...
	public void addParty(Party party)
	{
		...
		party.setCommandChannel(this);
		party.broadcastString("You have participated in the command channel.");
		// party.broadcastPacket(ExOpenMPCC.STATIC_PACKET);
	}
	...
	public void removeParty(Party party)
	{
		...
		if (_parties.size() < 2)
		{
			broadcastString("A command channel has been closed.");
			disbandChannel();
		}
		// else
		// {
	 ...
	 * @see org.l2jmobius.gameserver.entity.groups.AbstractPlayerGroup#forEachMember(Function)
	 */
	@Override
