...
import org.l2jmobius.gameserver.entity.actor.tasks.player.TeleportTask;
...
{
	private static final Location JAIL_IN_LOC = new Location(80151, -15445, -1805); // C1 fix for -114356, -249645, -2984
	...
	protected void onEnter(Creature creature)
	{
		if (creature.isPlayer())
		{
			...
			if (GeneralConfig.JAIL_IS_PVP)
			{
				...
				creature.sendPacket(SystemMessageId.YOU_HAVE_ENTERED_THE_BATTLEFIELD);
			}
	...
	protected void onExit(Creature creature)
	{
		if (creature.isPlayer())
		{
			...
			if (GeneralConfig.JAIL_IS_PVP)
			{
				...
				creature.sendPacket(SystemMessageId.YOU_HAVE_LEFT_THE_BATTLEFIELD);
			}
