...
public class AdminShowQuests implements IAdminCommandHandler
{
	...
	public boolean onCommand(String command, Player activeChar)
	{
		...
		{
			target = World.getPlayer(cmdParams[1]);
	...
	private void showFirstQuestMenu(Player target, Player actor)
	{
		...
		replyMSG.append("<table width=250><tr><td><button value=\"CREATED\" action=\"bypass -h admin_charquestmenu " + target.getName() + " 0\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td></tr>");
		replyMSG.append("<tr><td><button value=\"STARTED\" action=\"bypass -h admin_charquestmenu " + target.getName() + " 1\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td></tr>");
		replyMSG.append("<tr><td><button value=\"COMPLETED\" action=\"bypass -h admin_charquestmenu " + target.getName() + " 2\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td></tr>");
		replyMSG.append("<tr><td><br><button value=\"All\" action=\"bypass -h admin_charquestmenu " + target.getName() + " 3\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td></tr>");
		replyMSG.append("<tr><td><br><br>Manual Edit by Quest number:<br></td></tr>");
		replyMSG.append("<tr><td><edit var=\"qn\" width=65 height=12><br><button value=\"Edit\" action=\"bypass -h admin_charquestmenu " + target.getName() + " $qn custom\" width=65 height=21 back=\"L2UI.DefaultButton_click\" fore=\"L2UI.DefaultButton\"></td></tr>");
		...
		try (Connection con = DatabaseFactory.getConnection())
		{
			...
			switch (val[0])
			{
				...
				case "name":
				{
					...
					replyMSG.append("<tr><td><button value=\"Quest Complete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + val[1] + " state COMPLETED 1\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
					replyMSG.append("<td><button value=\"Quest Complete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + val[1] + " state COMPLETED 0\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td></tr>");
					replyMSG.append("</table><br><br><font color=\"ff0000\">Delete Quest from DB:</font><br><button value=\"Quest Delete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + val[1] + " state DELETE\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\">");
				...
				case "custom":
				{
					...
					if (exqdb)
					{
						if (exqch)
						{
							...
							replyMSG.append("</table><br><br><table width=250><tr><td>Repeatable quest:</td><td>Unrepeatable quest:</td></tr>");
							replyMSG.append("<tr><td><button value=\"Quest Complete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + qname + " state COMPLETED 1\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td>");
							replyMSG.append("<td><button value=\"Quest Complete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + qname + " state COMPLETED 0\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"></td></tr>");
							replyMSG.append("</table><br><br><font color=\"ff0000\">Delete Quest from DB:</font><br><button value=\"Quest Delete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + qname + " state DELETE\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\">");
							replyMSG.append("</center></body></html>");
						}
						else
						{
							...
							replyMSG.append("<button value=\"Create Quest\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + qnumber + " state CREATE\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"><br><br>");
							replyMSG.append("<font color=\"ee0000\">Only for Unrepeateble quests:</font><br>");
							replyMSG.append("<button value=\"Create & Complete\" action=\"bypass -h admin_setcharquest " + target.getName() + " " + qnumber + " state CC\" width=95 height=21 back=\"L2UI.pledgeButten2\" fore=\"L2UI.pledgeButten1\"><br><br>");
							replyMSG.append("</center></body></html>");
						}
					}
					else
