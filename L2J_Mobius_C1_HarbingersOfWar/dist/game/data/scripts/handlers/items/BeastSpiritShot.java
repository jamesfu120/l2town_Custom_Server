...
public class BeastSpiritShot implements IItemHandler
{
	...
	public boolean onItemUse(Playable playable, Item item, boolean forceUse)
	{
		...
		{
			playable.sendMessage("When Pet or Servitor is dead, soulshots or spiritshots for Pet or Servitor are not available.");
			return false;
		}
		...
		{
			activeOwner.sendMessage("When Pet or Servitor is dead, soulshots or spiritshots for Pet or Servitor are not available.");
			return false;
		}
		...
		if (shotCount < shotConsumption)
		{
			...
			{
				activeOwner.sendMessage("You don't have enough spiritshots needed for a pet/servitor.");
			}
		...
		activeOwner.sendMessage("Pet uses the power of spirit.");
