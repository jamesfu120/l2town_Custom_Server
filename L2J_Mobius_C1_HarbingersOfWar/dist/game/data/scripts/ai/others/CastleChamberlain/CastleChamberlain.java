...
public class CastleChamberlain extends Script
{
	...
	{
		new SkillHolder(1204, 2), // Wind Walk Lv.2
		new SkillHolder(1257, 3), // Decrease Weight Lv.3
		new SkillHolder(1040, 3), // Shield Lv.3
		new SkillHolder(1035, 4), // Mental Shield Lv.4
		new SkillHolder(1068, 3), // Might Lv.3
		new SkillHolder(1045, 2), // Bless the Body Lv.2
		new SkillHolder(1036, 1), // Magic Barrier Lv.1
		new SkillHolder(1259, 1), // Resist Shock Lv.1
		new SkillHolder(1048, 2), // Bless the Soul Lv.2
		new SkillHolder(1078, 2), // Concentration Lv.2
		new SkillHolder(1062, 1), // Berserker Spirit Lv.1
		new SkillHolder(1243, 2), // Bless Shield Lv.2
		new SkillHolder(1240, 1), // Guidance Lv.1
		new SkillHolder(7005, 1), // Vampiric Rage Lv.1
		new SkillHolder(1045, 6), // Bless the Body Lv.6
		new SkillHolder(1036, 2), // Magic Barrier Lv.2
		new SkillHolder(1259, 4), // Resist Shock Lv.4
		new SkillHolder(1048, 6), // Bless the Soul Lv.6
		new SkillHolder(1078, 6), // Concentration Lv.6
		new SkillHolder(1062, 2), // Berserker Spirit Lv.2
		new SkillHolder(1243, 6), // Bless Shield Lv.6
		new SkillHolder(1240, 3), // Guidance Lv.3
		new SkillHolder(7005, 4), // Vampiric Rage Lv.4
		new SkillHolder(1085, 1), // Acumen Lv.1
		new SkillHolder(1059, 1), // Empower Lv.1
		new SkillHolder(1086, 1), // Haste Lv.1
		new SkillHolder(1077, 1), // Focus Lv.1
		new SkillHolder(1242, 1), // Death Whisper Lv.1
	};
		...
		switch (st.nextToken())
		{
			...
			case "manage_vault":
			{
				if (isOwner(player, npc) && player.hasAccess(ClanAccess.CASTLE_VAULT))
				{
					...
					html.replace("%seed_income%", FormatUtil.formatAdena(0));
					player.sendPacket(html);
				}
				else
				{
					...
					else
					{
						...
						if (BUFFS.length > index)
						{
							...
							if (holder.getSkill().getMpConsume() < npc.getCurrentMp())
							{
								...
								player.sendPacket(new MagicSkillUse(npc, player, holder.getSkillId(), holder.getSkillLevel(), 0, 0));
