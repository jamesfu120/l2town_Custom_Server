...
public class BoatGludinRune implements Runnable
{
	...
	public BoatGludinRune(Boat boat)
	{
		...
		ARRIVED_AT_GLUDIN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Arrived at Gludin Harbor.");
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Rune Harbor after anchoring for ten minutes.");
		LEAVE_GLUDIN5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Rune Harbor in five minutes.");
		LEAVE_GLUDIN1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Rune Harbor in one minute.");
		LEAVE_GLUDIN0 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving soon for Rune Harbor.");
		LEAVING_GLUDIN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving for Gludin Harbor.");
		ARRIVED_AT_RUNE = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Arrived at Rune Harbor.");
		ARRIVED_AT_RUNE_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Gludin Harbor after anchoring for ten minutes.");
		LEAVE_RUNE5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Gludin Harbor in five minutes.");
		LEAVE_RUNE1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Gludin Harbor in one minute.");
		LEAVE_RUNE0 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving soon for Gludin Harbor.");
		LEAVING_RUNE = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving for Gludin Harbor.");
		BUSY_GLUDIN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Rune Harbor to Gludin Harbor has been delayed.");
		BUSY_RUNE = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor to Rune Harbor has been delayed.");
		
		ARRIVAL_RUNE15 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 15 minutes.");
		ARRIVAL_RUNE10 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 10 minutes.");
		ARRIVAL_RUNE5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 5 minutes.");
		ARRIVAL_RUNE1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 1 minute.");
		ARRIVAL_GLUDIN15 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 15 minutes.");
		ARRIVAL_GLUDIN10 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 10 minutes.");
		ARRIVAL_GLUDIN5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 5 minutes.");
		ARRIVAL_GLUDIN1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 1 minute.");
