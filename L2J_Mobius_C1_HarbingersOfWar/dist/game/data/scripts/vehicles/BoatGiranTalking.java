...
public class BoatGiranTalking implements Runnable
{
	...
	public BoatGiranTalking(Boat boat)
	{
		...
		ARRIVED_AT_GIRAN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Arrived at Giran Harbor.");
		ARRIVED_AT_GIRAN_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Talking Island Harbor after anchoring for ten minutes.");
		LEAVE_GIRAN5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Talking Island Harbor in five minutes.");
		LEAVE_GIRAN1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Talking Island Harbor in one minute.");
		LEAVE_GIRAN0 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving soon for Talking Island Harbor.");
		LEAVING_GIRAN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving for Talking Island Harbor.");
		ARRIVED_AT_TALKING = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Arrived at Talking Island Harbor.");
		ARRIVED_AT_TALKING_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Giran Harbor after anchoring for ten minutes.");
		LEAVE_TALKING5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Giran Harbor in five minutes.");
		LEAVE_TALKING1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Giran Harbor in one minute.");
		LEAVE_TALKING0 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving soon for Giran Harbor.");
		LEAVING_TALKING = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving for Giran Harbor.");
		BUSY_TALKING = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Giran Harbor to Talking Island has been delayed.");
		
		ARRIVAL_TALKING15 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Giran Harbor will be arriving at Talking Island in approximately 15 minutes.");
		ARRIVAL_TALKING10 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Giran Harbor will be arriving at Talking Island in approximately 10 minutes.");
		ARRIVAL_TALKING5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Giran Harbor will be arriving at Talking Island in approximately 5 minutes.");
		ARRIVAL_TALKING1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Giran Harbor will be arriving at Talking Island in approximately 1 minute.");
		ARRIVAL_GIRAN20 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Giran Harbor in approximately 20 minutes.");
		ARRIVAL_GIRAN15 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Giran Harbor in approximately 15 minutes.");
		ARRIVAL_GIRAN10 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Giran Harbor in approximately 10 minutes.");
		ARRIVAL_GIRAN5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Giran Harbor in approximately 5 minutes.");
		ARRIVAL_GIRAN1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Giran Harbor in approximately 1 minute.");
