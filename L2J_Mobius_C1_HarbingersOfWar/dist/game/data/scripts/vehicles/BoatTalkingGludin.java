...
public class BoatTalkingGludin implements Runnable
{
	...
	public BoatTalkingGludin(Boat boat)
	{
		...
		ARRIVED_AT_TALKING_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Gludin Harbor after anchoring for ten minutes.");
		LEAVE_TALKING5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Gludin Harbor in five minutes.");
		LEAVE_TALKING1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Gludin Harbor in one minute.");
		LEAVE_TALKING1_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Those wishing to ride should make haste to get on.");
		LEAVE_TALKING0 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving soon for Gludin Harbor.");
		LEAVING_TALKING = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving for Gludin Harbor.");
		ARRIVED_AT_GLUDIN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Arrived at Gludin Harbor.");
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Talking Island Harbor after anchoring for ten minutes.");
		LEAVE_GLUDIN5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Talking Island Harbor in five minutes.");
		LEAVE_GLUDIN1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Will leave for Talking Island Harbor in one minute.");
		LEAVE_GLUDIN0 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving soon for Talking Island Harbor.");
		LEAVING_GLUDIN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "Leaving for Talking Island Harbor.");
		BUSY_TALKING = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor to Talking Island has been delayed.");
		BUSY_GLUDIN = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island to Gludin Harbor has been delayed.");
		
		ARRIVAL_GLUDIN10 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will arrive at Gludin Harbor in approximately 10 minutes.");
		ARRIVAL_GLUDIN5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Gludin Harbor in approximately 5 minutes.");
		ARRIVAL_GLUDIN1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Talking Island will be arriving at Gludin Harbor in approximately 1 minute.");
		ARRIVAL_TALKING10 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Talking Island in approximately 10 minutes.");
		ARRIVAL_TALKING5 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Talking Island in approximately 5 minutes.");
		ARRIVAL_TALKING1 = new CreatureSay(boat, ChatType.BOAT, "Passenger Boat Info", "The ferry from Gludin Harbor will be arriving at Talking Island in approximately 1 minute.");
