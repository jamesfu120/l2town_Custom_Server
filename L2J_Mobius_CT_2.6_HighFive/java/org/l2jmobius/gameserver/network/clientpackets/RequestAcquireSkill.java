...
import org.l2jmobius.gameserver.entity.actor.instance.VillageMaster;
	...
	protected void runImpl()
	{
		...
		switch (_skillType)
		{
			...
			case SUBCLASS:
			{
				...
				if (qs == null)
				{
					final Quest subClassSkilllsQuest = ScriptManager.getInstance().getScript("SubClassSkills");
