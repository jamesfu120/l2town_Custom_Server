...
public class ChatGeneral implements IChatHandler
{
	...
	public void onChat(ChatType type, Player activeChar, String paramsValue, String text)
	{
		...
		if (!vcdUsed)
		{
			...
			{
				activeChar.sendPacket(new SystemMessage(SystemMessageId.NON_PA_USERS_OF_LV_S1_OR_LOWER_CANNOT_USE_THE_GENERAL_CHAT).addInt(GeneralConfig.MINIMUM_CHAT_LEVEL));
				return;
			}
