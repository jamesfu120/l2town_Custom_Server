...
public class PetitionManager
{
	...
	public void sendPendingPetitionList(Player player)
	{
		...
		for (Petition currPetition : _pendingPetitions.values())
		{
			...
			htmlContent.append("<tr><td width=\"270\"><table width=\"270\" cellpadding=\"2\" bgcolor=" + (color ? "000000" : "444444") + "><tr><td width=\"130\">" + DATE_FORMAT.format(Instant.ofEpochMilli(currPetition.getSubmitTime()).atZone(ZoneId.systemDefault())));
