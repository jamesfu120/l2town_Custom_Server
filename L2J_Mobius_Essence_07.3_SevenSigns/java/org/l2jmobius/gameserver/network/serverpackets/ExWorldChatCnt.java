...
public class ExWorldChatCnt extends ServerPacket
{
	...
	{
		_points = (player.getLevel() < GeneralConfig.WORLD_CHAT_MIN_LEVEL) || (VipSystemConfig.VIP_SYSTEM_ENABLED && (player.getVipTier() <= 0)) ? 0 : Math.max(player.getWorldChatPoints() - player.getWorldChatUsed(), 0);
	}
